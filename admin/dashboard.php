...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-dark p-2 text-white mb-4">
                                    <div class="card-body">Total Registered Users  <br><br>
                                        <span style="font-size:39px;"> <?php echo $totalusers;?></span></div>
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-dark p-2 text-white mb-4">
                                    <div class="card-body">Yesterday Registered Users <br><br>
                                        <span style="font-size:39px;"> <?php echo $yesterdayregusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-dark p-2 text-white mb-4">
                                    <div class="card-body"> Registered Users in Last 7 Days <br>
                                        <span style="font-size:39px;"> <?php echo $last7daysregusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-dark p-2 text-white mb-4">
                                    <div class="card-body">Registered Users in Last 30 Days <br>
                                        <span style="font-size:39px;"> <?php echo $last30daysregusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
