...
<hr />
    <h3 class="text-center font-weight-light my-4">User Sign-in</h3></div>
                                    <div class="card-body">
...
<a class="link-danger small" href="password-recovery.php">Forgot Password?</a>
<button class="btn btn-danger" name="login" type="submit">Login</button>
</div>
</form>
</div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="signup.php" class="link-danger">Need an account? Sign up!</a></div>
